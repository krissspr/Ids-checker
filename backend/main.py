...
# CORS configuration that should work with Railway
app.add_middleware(
    CORSMiddleware,
...
# Custom CORS headers for Railway
@app.middleware("http")
async def add_cors_headers(request, call_next):
    response = await call_next(request)
    response.headers["Access-Control-Allow-Origin"] = "https://ids-checker.vercel.app"
